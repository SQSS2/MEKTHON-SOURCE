...
from yamenthon import LOGS, jmubot, HNDLR
from yamenthon.decorators import fullsudos, owner_and_sudos 
...
async def Jmthon_handler(event):
...
async def bot_stat(event):
    ...
    msg = """حـالة البـوت المساعـد من ميكثون
