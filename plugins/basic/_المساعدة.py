...
from yamenthon.decorators.asstbot import callback, in_pattern
from yamenthon.load_plug import PLUGINS
...
async def inline_handler(event):
    ...
    if inline_pic():
        ...
        result = await event.builder.article(
            title="**⌔∮ قائمة أوامر سورس مــيكثون**", text=text, buttons=get_help_buttons()
        )
...
async def help_func(moh):
    ...
    _strings = {
        "basic": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/mekthon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد القوائم الموجودة: {}**",
        "account": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/Mekthon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
        "fun": "**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/Mekthon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
        "group":"**⌔∮ مجموعة المساعدة: [أضغط هنا](t.me/Mekthon_Gorop)**\n**❃ مالك الحساب هو: {}.\n❃ عدد قوائم الموجودة: {}**",
    }
...
async def opner(event):
    await event.edit(
        "**⌔∮ القائمة الرئيسية لـ أوامر سورس مــيكثون**\n**❃ مالك الحساب هو: {}.\n❃ عدد القوائم الموجودة: {}**".format( 
            jmubot.full_name,
            len(PLUGINS),
        ),
        buttons=get_help_buttons(),
