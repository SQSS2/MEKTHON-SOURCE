...
async def restart_jmthon(event):
    ...
    for step in restart_steps:
        progress_text = (
            f"𓆩 [MEKTHON SOURCE](t.me/MEKTHON) 𓆪\n"
            f"**{step['message']}**\n\n"
    ...
    os.execl(sys.executable, sys.executable, "-m", "MEKTHON ")

@jmthon_cmd(pattern="تحديث( (.*)|$)")
async def update_jmthon(e):
    xx = await e.eor("**⌔∮ جار البحث عن تحديثات لسورس ميكثون**")
    ...
    if not m:
        return await xx.edit(
            f'<strong>سورس ميكثون مُحدث بأخر أصدار</strong>',
            parse_mode="html",
            link_preview=False,
        )
