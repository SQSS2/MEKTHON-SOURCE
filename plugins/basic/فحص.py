"""
❃ `{i}فحص`
    **⌔∮ لـ عرض حالة سورس ميكثون والاصدار و وقت التشغيل**
...
buttons = [
    [
        Button.url("مجموعة المساعدة", "t.me/MEKTHON_Gorop"),
        Button.url("قناة السورس", "t.me/MEKTHON"),
    ]
]

alive_txt = """
سورس ميكثون يعمل بنجاح
...
in_alive = "{}\n\n❃ <b>إصدار ميكثون -><b> <code>{}</code>\n❃ <b>إصدار البايثون -></b> <code>{}</code>\n❃ <b>مدة التشغيل -></b> <code>{}</code>\n\n<b>قناة السورس @MEKTHON</b>"
alive_1 = "** سورس  ميكثون  يعمـل .. بنجـاح ☑️ 𓆩 **\n\n❃ **مالك الحساب** - `{}`\n❃ **إصدار ميكثون** - `{}`\n❃ **مدة التشغيل** - `{}`\n❃ **إصدار البايثون** - `{}`\n❃ **إصدار التيليثون** - `{}`\nقنـاة السـورس @MEKTHON"
