...
file = f"YamenThon{sys.argv[6]}.log" if len(sys.argv) > 6 else "YamenThon.log"

if os.path.exists(file):
    os.remove(file)


LOGS = getLogger("Mekthon")
...
LOGS.info(f"إصدار ميكثون ➤ 1.0.0 [{platform.system()}]")
