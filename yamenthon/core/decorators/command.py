    ...
    def decor(dec):
        ...
        async def wrapp(mirza: Message):
            ...
            try:
                ...
                await tgbot.send_message(
                    jmdB.get_config("LOG_CHAT"), "**⌔∮ سورس ميكثون يعمل بنجاح مرة أخرى**")
                return
...
"""
                ...
                try:
                    ...
                    graphLink = await mkgraph("Mekthon Error", MakeHtml)
